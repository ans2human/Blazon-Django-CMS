"""
Django settings for Manand project.
...
SECRET_KEY = 'p5tl92jyd=)%rn3u%$k+--si6(=j8tf66j1h7lkz(%a%by@3bu'
...
WSGI_APPLICATION = 'Manand.wsgi.application'
